...
template <typename T>
struct HasDensity : boost::false_type {
  static void addData(VTKWriter<typename T::scalarType>& writer,const ParticleSetTpl<T>& pset) {}
};
template <typename T>
struct HasPressure : boost::false_type {
  static void addData(VTKWriter<typename T::scalarType>& writer,const ParticleSetTpl<T>& pset) {}
};
template <typename T>
struct HasWeight : boost::false_type {
  static void addData(VTKWriter<typename T::scalarType>& writer,const ParticleSetTpl<T>& pset) {}
};
template <typename T>
struct HasTargetVolume : boost::false_type {
  static void addData(VTKWriter<typename T::scalarType>& writer,const ParticleSetTpl<T>& pset) {}
};
template <typename T>
...
struct ParticleBase : public Serializable {
  ...
  ParticleBase():Serializable(-1),_pos(0.0f,0.0f,0.0f) {}
...
template <typename T>
struct HasVel<ParticleSPH<T> > : public boost::true_type {
...
template <typename T>
struct HasDensity<ParticleSPH<T> > : boost::true_type {
  typedef ParticleSetTpl<ParticleSPH<T> > PS_TYPE;
  static void addData(VTKWriter<T>& writer,const PS_TYPE& pset) {
...
template <typename T>
struct HasPressure<ParticleSPH<T> > : boost::false_type {
  typedef ParticleSetTpl<ParticleSPH<T> > PS_TYPE;
  static void addData(VTKWriter<T>& writer,const PS_TYPE& pset) {
...
template <typename T>
struct HasWeight<ParticleSPH<T> > : boost::true_type {
  typedef ParticleSetTpl<ParticleSPH<T> > PS_TYPE;
  static void addData(VTKWriter<T>& writer,const PS_TYPE& pset) {
...
template <typename T>
struct HasTargetVolume<ParticleSPH<T> > : boost::false_type {
  typedef ParticleSetTpl<ParticleSPH<T> > PS_TYPE;
  static void addData(VTKWriter<T>& writer,const PS_TYPE& pset) {
...
template <typename T>
struct HasType<ParticleSPH<T> > : boost::false_type {
  typedef ParticleSetTpl<ParticleSPH<T> > PS_TYPE;
  static void addData(VTKWriter<T>& writer,const PS_TYPE& pset) {
