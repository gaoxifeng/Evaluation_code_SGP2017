...
bool glShader::link(GLsizei count, const char** varyings,GLenum mode)
{
  _inUse=false;
  ...
  if(count > 0)
    glTransformFeedbackVaryings(ProgramObject, count, varyings, mode);
...
// ----------------------------------------------------------------------------
GLint glShaderObject::getAttribLocation(const char* attribName)
{
...
// ----------------------------------------------------------------------------
glShader* glShaderManager::loadfromFile(const char* vertexFile,const char* fragmentFile,GLsizei count,const char** varyings,GLenum mode)
{
...
glShader* glShaderManager::loadfromFile(const char* vertexFile,const char* geometryFile,const char* fragmentFile,GLsizei count,const char** varyings,GLenum mode)
{
  glShader* o = new glShader();
...
glShader* glShaderManager::loadfromMemory(const char* vertexMem, const char* fragmentMem,GLsizei count,const char** varyings,GLenum mode)
{
  glShader* o = new glShader();
  o->UsesGeometryShader(false);
...
glShader* glShaderManager::loadfromMemory(const char* vertexMem, const char* geometryMem, const char* fragmentMem,GLsizei count,const char** varyings,GLenum mode)
{
  glShader* o = new glShader();
  o->UsesGeometryShader(true);
  o->SetInputPrimitiveType(_nInputPrimitiveType);
